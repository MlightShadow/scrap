...
public class UploadFileController {
    ...
    @PostMapping
    public Result<?> add(@RequestBody UploadFileDTO dto) {
        return ResultGenerator.genSuccessResult(uploadFileService.addUploadFile(dto));
    }
    ...
    public Result<?> delete(@PathVariable String id) {
        return ResultGenerator.genSuccessResult(uploadFileService.deleteUploadFile(id));
    }

    @NeedApiLog
    @ApiOperation(value="更新")
    @PutMapping("/{id}")
    public Result<?> update(@PathVariable String id, @RequestBody UploadFileDTO dto) {
        return ResultGenerator.genSuccessResult(uploadFileService.updateUploadFile(id, dto));
    }
    ...
    public Result<?> list(@RequestParam(defaultValue = "0") Integer page, 
        ...
        Condition condition = new Condition(UploadFile.class);
        ...
        List<UploadFile> list = uploadFileService.findByCondition(condition);
        PageInfo<?> pageInfo = new PageInfo<UploadFile>(list);
