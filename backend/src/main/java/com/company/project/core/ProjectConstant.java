...
public final class ProjectConstant {
    ...
    public static final String DTO_PACKAGE = BASE_PACKAGE + ".dto";// 生成的Controller所在包

    public static final String MAPPER_INTERFACE_REFERENCE = BASE_PACKAGE + ".core.Mapper";// Mapper插件基础接口的完全限定名
    public static final String VIEW_MAPPER_INTERFACE_REFERENCE = BASE_PACKAGE + ".core.ViewMapper";// Mapper插件基础接口的完全限定名
}
